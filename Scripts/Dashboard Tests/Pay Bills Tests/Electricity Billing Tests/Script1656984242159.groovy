...
WebUI.click(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/button_Utility'))

WebUI.delay(2)

WebUI.click(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/input_Provider_rc_select_8'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/div_Ikeja Electricity Distribution Company (IKEDC)'))

WebUI.delay(2)

WebUI.click(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/input_Plan_rc_select_3'))

WebUI.click(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/div_prepaid'))

WebUI.setText(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/input_Meter Number_meterNumber'), '04274879248')

WebUI.delay(3)

WebUI.setText(findTestObject('Dashboard/Pay Bills Page/Electricity billing Page/input_Amount_amount'), '10000')

WebUI.setText(findTestObject('Dashboard/Pay Bills Page/Cable Tv Page/input_Phone Number_phoneNumber'), '09999998999')

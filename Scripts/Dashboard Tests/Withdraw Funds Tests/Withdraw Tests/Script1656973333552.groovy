...
WebUI.click(findTestObject('Dashboard/Withdraw Page/Dashboard Page/button_withdraw'))

WebUI.setText(findTestObject('Dashboard/Withdraw Page/Dashboard Page/input_Amount'), '1')

WebUI.click(findTestObject('Dashboard/Withdraw Page/Dashboard Page/button_Continue'))

WebUI.click(findTestObject('Dashboard/Withdraw Page/Dashboard Page/Button_Continue Summary Page'))
...
WebUI.click(findTestObject('Dashboard/Withdraw Page/Dashboard Page/Button_Continue Pin Page'))

WebUI.click(findTestObject('Dashboard/Transfer Page/Dashboard Page/button_Back To Dashboard'))

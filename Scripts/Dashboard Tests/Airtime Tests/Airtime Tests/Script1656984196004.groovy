...
WebUI.click(findTestObject('temp/iframe/Page_VPay  Dashboard/hide chat'))

WebUI.click(findTestObject('Dashboard/Airtime Page/Airtime/p_airtime'))
...
WebUI.setText(findTestObject('Dashboard/Airtime Page/Airtime/enter amount'), '30000')

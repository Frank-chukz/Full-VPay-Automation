...
WebUI.click(findTestObject('Dashboard/Transfer Page/Dashboard Page/button_transfer'))

WebUI.click(findTestObject('Dashboard/Transfer Page/Dashboard Page/button_New Beneficiary'))

WebUI.click(findTestObject('Dashboard/Transfer Page/Dashboard Page/input_Bank Name'))

WebUI.setText(findTestObject('Dashboard/Transfer Page/Dashboard Page/input_Bank Name'), 'VFD')

WebUI.click(findTestObject('Dashboard/Transfer Page/Dashboard Page/div_VFD MICROFINANCE BANK'))

WebUI.setText(findTestObject('Dashboard/Transfer Page/Dashboard Page/input_Account Number'), '1000482169')

WebUI.setText(findTestObject('Dashboard/Transfer Page/Dashboard Page/input_Amount_amount'), '1')

WebUI.setText(findTestObject('Dashboard/Transfer Page/Dashboard Page/input_Remark'), 'This is a test')

WebUI.click(findTestObject('Dashboard/Transfer Page/Dashboard Page/button_Save Beneficiary toggle 1'))

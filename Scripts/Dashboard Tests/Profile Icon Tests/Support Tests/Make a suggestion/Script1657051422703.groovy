...
WebUI.click(findTestObject('Dashboard/Profile Page/Support Page/Make a suggesgtion Page/span make a suggestion'))

WebUI.click(findTestObject('Dashboard/Profile Page/Support Page/Make a suggesgtion Page/email sending for suggestion'))

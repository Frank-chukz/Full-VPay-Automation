...
WebUI.click(findTestObject('Dashboard/Profile Page/Support Page/Chat Admin Page/Telegram chat/Send telegram message'))

WebUI.switchToWindowIndex(1)

WebUI.click(findTestObject('Dashboard/Profile Page/Support Page/Chat Admin Page/Telegram chat/Page_Telegram Join Group Chat/a_Join Group'))

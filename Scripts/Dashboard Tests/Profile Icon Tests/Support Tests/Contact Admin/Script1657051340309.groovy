...
WebUI.click(findTestObject('Dashboard/Profile Page/Support Page/Contact admin page/Contact Admin'))

WebUI.click(findTestObject('Dashboard/Profile Page/Support Page/Contact admin page/Contact support phone number'))

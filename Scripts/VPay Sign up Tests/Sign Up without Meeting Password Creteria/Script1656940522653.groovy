...
WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_First Name'), 'Franklin')

WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Last Name'), 'Emeka')

WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Phone Number'), '01102090987')

WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Email Address'), 'qa101_24r@givmail.com')

WebUI.setEncryptedText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Password'), 'lHi4iwJKqllFp1IlGPLsTA==')

WebUI.setEncryptedText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Confirm Password'), 'lHi4iwJKqllFp1IlGPLsTA==')

WebUI.click(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/button_Create My Account'))

WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Business Account Details Page/input_Legal Business Name'), 'Ekens Ventures')
...
WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Business Account Details Page/input_Street Address'), 'Ekems street off 123 road')

...
WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Phone Number'), '09989898989')

WebUI.setText(findTestObject('Account Management Page/VPay Onboarding/Personal Details Page/input_Email Address'), 'qa101_t120lm@givmail.com')
